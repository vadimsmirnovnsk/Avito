...
- (instancetype)initWithDictionary:(NSDictionary *)dictionary
{
	...
	_author = dictionary[@"artistName"];
	_imageURLString = dictionary[@"artworkUrl100"];
